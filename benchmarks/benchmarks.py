"""Benchmarking for nametag-mcp."""

from nametag_mcp import make_greeting


class TimeSuite:
    """A benchmark suite for timing nametag-mcp."""
...
class MemSuite:
    """A benchmark suite for measuring the memory usage of nametag-mcp."""

...
<!-- Build -->
[badge-actions]: https://img.shields.io/github/actions/workflow/status/MicaelJarniac/nametag-mcp/ci.yml?branch=main&style=flat-square
[actions]: https://github.com/MicaelJarniac/nametag-mcp/actions
[badge-semantic-release]: https://img.shields.io/badge/%20%20%F0%9F%93%A6%F0%9F%9A%80-semantic--release-e10079?style=flat-square
[semantic-release]: https://github.com/semantic-release/semantic-release
[badge-pypi]: https://img.shields.io/pypi/v/nametag-mcp?style=flat-square
[pypi]: https://pypi.org/project/nametag-mcp
[badge-docs]: https://img.shields.io/readthedocs/nametag-mcp?style=flat-square
[docs]: https://nametag-mcp.readthedocs.io

<!-- Tests -->
[badge-coverage]: https://img.shields.io/codecov/c/gh/MicaelJarniac/nametag-mcp?logo=codecov&style=flat-square
[coverage]: https://codecov.io/gh/MicaelJarniac/nametag-mcp
...
<!-- Repo -->
[badge-issues]: https://img.shields.io/github/issues/MicaelJarniac/nametag-mcp?style=flat-square
[issues]: https://github.com/MicaelJarniac/nametag-mcp/issues
[badge-stars]: https://img.shields.io/github/stars/MicaelJarniac/nametag-mcp?style=flat-square
[stars]: https://github.com/MicaelJarniac/nametag-mcp/stargazers
[badge-license]: https://img.shields.io/github/license/MicaelJarniac/nametag-mcp?style=flat-square
[license]: https://github.com/MicaelJarniac/nametag-mcp/blob/main/LICENSE
...
Welcome to **Nametag MCP's** documentation!
...
### PyPI
[*nametag-mcp*][pypi] is available on PyPI:

```bash
# With uv
uv add nametag-mcp
# With pip
pip install nametag-mcp
# With Poetry
poetry add nametag-mcp
```
...
```bash
# With uv
uv add git+https://github.com/MicaelJarniac/nametag-mcp
# With pip
pip install git+git://github.com/MicaelJarniac/nametag-mcp
# With Poetry
poetry add git+git://github.com/MicaelJarniac/nametag-mcp
```
...
```python
from nametag_mcp import nametag_mcp
```
